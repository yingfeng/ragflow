...
示例：general/v2/`,
      ...
      mineru: {
        ...
        backendOptions: {
          ...
          vlmLmdeployEngine: '基于 LMDeploy 引擎的视觉语言模型（实验性）',
        },
      },
      somark: {
        modelNameMessage: '请输入模型名称',
    ...
    knowledgeCompilation: {
      ...
      fieldRule: '规则',
      fieldDomain: '定义域（起点的类）',
      fieldRange: '值域（终点的类）',
      fieldLabel: '显示名（rdfs:label）',
      fieldParent: '父类（rdfs:subClassOf）',
      fieldKind: '属性种类（object / datatype）',
      fieldDatatype: '数据类型（字面量值域）',
      ontology: '本体',
      ontologyInstanceCount: '{{count}} 个实例',
      ontologySearchClass: '查找类…',
      ontologyGraphStats:
        '{{classes}} 个类 · {{properties}} 条属性 · {{entities}} 个实体 · {{relations}} 条关系',
      ontologyCountsTruncated: '计数在扫描上限处停止，因此为下界。',
      ontologyUnattributed: '{{count}} 条关系没有类，未出现在图上。',
      ontologyDeclaredClass: '已声明的类',
      ontologyUndeclaredClass: '数据中出现但未声明',
      ontologyProperties: '属性',
      ontologyNoProperties: '没有属性连接这个类。',
      ontologyAttributes: '数据类型属性',
      ontologyNoAttributes: '没有为它声明数据类型属性。',
      ontologyInheritedFrom: '继承自 {{name}}',
      ontologyInheritance: '继承',
      ontologyNoInheritance: '没有父类，也没有子类。',
      ontologyShowInheritance: '继承边',
      ontologyInheritanceCount: '{{count}} 条继承边',
      ontologyViewInstances: '查看实例',
      ontologyViewAssertions: '查看断言',
      ontologyDrilldownTotal: '范围内共 {{count}} 行',
      ontologyDrilldownLoading: '加载中…',
      ontologyDrilldownEmpty: '还没有编译出内容。',
      ontologyDrilldownMore: '另有 {{count}} 行未显示',
      ontologyGoToClass: '跳到另一端类',
      ontologyShowUndeclared: '显示未声明的类与属性',
      ontologyFocusedOnly: '只画选中类的边',
      ontologyNoInstancesToShow: '本范围内这个类没有编译出实例，没有列表可打开。',
      ontologyDrilldownFailed: '请求失败：{{message}}',
      ontologyDrilldownLoadMore: '再加载 {{count}} 条',
      ontologyDrilldownAllShown: '已显示全部 {{count}} 条',
      ontologyDrilldownCapped: '已显示前 {{shown}} / {{total}} 条 —— 想看完请在更小的范围内打开这个类',
      ontologyMoreAttributes: '另有 {{count}} 个属性',
      ontologyResetLayout: '重新布局',
      ontologyAddClass: '+ 类',
      ontologyAutoArrange: '自动排列',
      ontologyDragHint: '拖动类可调整位置；位置不会写入模板。',
      ontologyCanvas: '本体画布',
      ontologySelectHint: '在画布上选择类或属性。',
      ontologyClass: '类',
      ontologyProperty: '属性',
      ontologyDeleteClass: '删除该类',
      ontologyDeleteProperty: '删除该属性',
      ontologyPitfallCategory_logical: '逻辑问题',
      ontologySaveBlocked: '有 {{count}} 个本体问题需要先修正 —— 画布上已列出。',
      ontologyQualityTitle: '编译质量',
      ontologyQualityLine: '编译质量：未声明 {{undeclared}} · 被拒 {{rejected}} · 无类 {{untyped}} · 缺陷 {{findings}} · 未被使用 {{uncovered}}',
      ontologyQualityWhereToFix: '勾选你要接受的改动，然后点「应用并重编译」：这些行改的是**模板声明**，编译才会让数字变化。只重新编译文档不会改变这里。',
      ontologyQualityApply: '改模板',
      ontologyQualitySelect: '选中',
      ontologyQualityPending: '· 已选 {{count}} 项，尚未应用',
      ontologyQualityNothingMeasured: '— 本范围没有编译出任何对象属性断言（实体 {{entities}} 个、断言 0 条）：上面的 0 是**空集**，不是合规。',
      ontologyQualityApplyBatchHint: '— 先写回模板，再重编译；只重新编译文档不会生效。',
      ontologyQualitySelected: '已选 {{count}} 项',
      ontologyQualityApplyBatch: '应用并重编译',
      ontologyQualityClearSelection: '清除选择',
      ontologyQualityApplying: '正在写回模板…',
      ontologyQualityApplied: '已应用 {{count}} 处修改；正在重跑受影响文档的编译，跑完后数字会更新。',
      ontologyQualityApplyYes: '确认修改',
      ontologyQualityApplyFailed: '模板未修改：{{message}}',
      ontologyQualityActionWiden: '把「{{class}}」加进 {{property}} 的 {{side}}（当前声明：{{declared}}）—— 一次覆盖 {{count}} 条断言',
      ontologyQualityActionNothingDeclared: '未声明',
      ontologyQualityActionDeclare: '补一条声明：',
      ontologyQualityActionDeclareAs: '—— 观察为 {{domain}} → {{range}}',
      ontologyQualityActionSeenTimes: '已有 {{count}} 条断言在用这个名字',
      ontologyQualityShow: '查看要改什么',
      ontologyQualityHide: '收起要改什么',
      ontologyQualityPass: '—— 本范围没有需要修的地方。',
      ontologyQualityScope: '按当前范围统计。下面每一项的修复动作都是改模板或重读文档，不是改某一行数据。',
      ontologyQualityUndeclared: '未声明的属性',
      ontologyQualityUndeclaredHint: '—— 数据里出现、模板没声明；每一行就是该补的那条声明。',
      ontologyQualityEndpointGaps: '未声明的端点组合',
      ontologyQualityEndpointGapsHint: '— 属性已声明，是这一对端点没声明；每行是把某一侧补上。',
      ontologyQualityActionClassUndeclared: '{{class}} 本身也未声明，请先声明该类。',
      ontologyQualityDropped: '被拒绝的断言',
      ontologyQualityDroppedHint: '—— 声明写窄了；每一行就是把它放进来所需的那个改动。',
      ontologyQualityDroppedMore: '只列出第一页；上面的数字是完整的。',
      ontologyQualityUntyped: '没有类的实体',
      ontologyQualityUntypedHint: '—— 抽取没给出类，这些行上不了图；把该类的 rule 写清后重跑。',
      ontologyQualityPitfalls: '声明缺陷',
      ontologyQualityPitfallsHint: '—— 模板自身的问题；在编辑器里改即可，不需要重跑编译。',
      ontologyQualityCoverage: '未被使用',
      ontologyQualityCoverageHint: '— 本范围声明了 {{declared}} 个端点对，其中 {{exercised}} 个有线；下面列的是**一条断言都没有**的属性（单文档里大多正常，先看数据集范围再决定是否改）。',
      ontologyQualityNoSubjects: '无需列出',
      ontologyLinkingHint: '点一个已有类连到 {{from}}，或点空白处新建一个相连的类（Esc 取消）。',
      ontologyMoreSettings: '更多设置',
      ontologyLinkHandle: '连线：先点这里，再点一个已有类；或点空白处新建一个相连的类。',
      ontologyOwnProperties: '这个类的属性',
      ontologyNoOwnProperties: '还没有。',
      ontologyAddOwnAttribute: '+ 属性',
      ontologyRelationsViaHandle: '关系从节点右侧的 + 手柄发起。',
      ontologyBelongsTo: '属于',
      ontologyBundleHeader: '这条边上有 {{count}} 条属性',
      ontologyBundleHint: '点其中一条即可编辑。',
      ontologyResizePanel: '调整面板宽度',
      ontologyResizePanelHint: '拖动调整宽度；双击恢复默认。',
      ontologyNoDomain: '还没选类 —— 画布上不会画出它',
      ontologyFoldMeta: '收起设置',
      ontologyIssue_class_without_type: '类必须有名称（type）',
      ontologyIssue_duplicate_class: '有两个类的名称相同',
      ontologyIssue_no_class: '本体模板至少要声明一个类',
      ontologyIssue_class_without_description: '类缺少描述',
      ontologyIssue_unknown_parent: '类声明的父类不在已声明的类里',
      ontologyIssue_cyclic_parent: '继承链成环',
      ontologyIssue_property_without_type: '属性必须有名称（type）',
      ontologyIssue_duplicate_property: '有两个属性的名称相同',
      ontologyIssue_property_without_description: '属性缺少描述',
      ontologyIssue_invalid_kind: '属性的 kind 只能是 object 或 datatype',
      ontologyIssue_missing_domain: '属性没有声明定义域（domain）',
      ontologyIssue_unknown_domain: '属性的定义域不是已声明的类',
      ontologyIssue_missing_range: '对象属性没有声明值域（range）',
      ontologyIssue_unknown_range: '属性的值域不是已声明的类',
      ontologyIssue_unsupported_datatype: '数据类型不在支持列表内',
      ontologyPitfallCategory_structural: '结构问题',
      ontologyPitfallCategory_naming: '命名问题',
      ontologyPitfallCategory_semantic: '语义问题',
      ontologyPitfall_dangling_property: '属性指向了模板未声明的端点类',
      ontologyPitfall_dangling_parent: '类声明的父类不是已声明的类',
      ontologyPitfall_redundant_parent: '类同时声明了父类与其祖先类，其中一条边没有信息',
      ontologyPitfall_class_without_property: '没有任何属性触达这个类（自身与继承都没有）',
      ontologyPitfall_orphan_class: '这个类既没有属性、也没有编译出的实例，只能画成孤立节点',
      ontologyPitfall_single_child_parent: '某个父类只有一个子类',
      ontologyPitfall_disconnected_hierarchy: '继承层级有多个根，被切成互不相连的树',
      ontologyPitfall_endpoint_ancestor_expansion: '属性同时声明了某个类和它的祖先类，祖先已经覆盖了它',
      ontologyPitfall_property_name_hierarchy: '属性名嵌套在另一个属性名里、且类间关系相同或更窄，形似子属性',
      ontologyPitfall_standard_vocabulary_property: '该名称已被 RDF/OWL 标准词汇占用',
      ontologyPitfall_range_in_property_name: '属性名里重复了它指向的值域类',
      ontologyPitfall_domain_in_property_name: '属性名里重复了它的定义域类',
      ontologyPitfall_overly_generic_class: '名称过于笼统，抽取模型会把什么都归到它下面',
      ontologyPitfall_class_property_name_collision: '这个名字同时被一个类和一个属性使用',
      ontologyPitfall_datatype_is_class: '声明的数据类型是本体的一个类，说明它本该是对象属性',
      addField: '添加字段',
      editField: '编辑字段',
      ...
      claimExtractionPrompt: 'Claim 抽取提示词',
      claimExtractionPromptTip:
        '聚类前从叶子 chunk 收割原子命题（附逐字证据）的系统提示词。留空使用内置契约。',
      maxToken: '最大 token 数',
      ...
      skillDeleteAllTitle: '删除全部 Skills',
      skillDeleteAllDescription: '确定要删除全部 Skills 吗？此操作无法撤销。',
      ...
      navKeywords: 'Keyword',
      navEntities: 'Entity',
      navGraphContent: '完整 Graph 内容',
      navDocCount: '{{count}} 个文档',
      navDeleteAllTitle: '删除 PageIndex',
      ...
      claimsLoading: '正在加载证据链…',
      claimsEmpty: '未提取到证据链。',
      claimsLoadMore: '加载更多（还剩 {{remaining}} 条）',
      claimsMoreEvidence: '还有 {{count}} 条证据',
      claimsCollapseEvidence: '收起',
      claimsNodeDetail: '详情',
    },
    message: {
      registered: '注册成功',
    ...
    fileManager: {
      ...
      preview: '预览',
      fileError: '文件错误',
      uploadLimit: '文件大小不能超过 10M，文件总数不超过 128 个',
...
适用场景：内容连续、上下文关联较强的文档，例如书籍、手册、报告和文章。这类文档通常需要保留相邻段落，以维持叙述连贯性。`,
      ...
      ref: '引用变量',
      stockCode: '股票代码',
      apiKeyPlaceholder: '您的 API 密钥(从 https://serpapi.com 获取)',
      flowStart: '开始',
      flowNum: '编号',
      test: '测试',
      extractDepth: '深度提取',
      ...
      queritTimeRangeTip:
        '可填写 d7、w2、m1、y1 等相对时间，或 2026-01-01 to 2026-01-31 形式的绝对日期范围。',
...
<instructions>
      ...
      loop: '循环',
      loopDescription:
        'loop 为当前组件循环次数上限，当循环次数超过 loop 的值时，说明组件不能完成当前任务，请重新优化 agent',
      exitLoop: '退出循环',
      ...
      generateDescription: `此组件用于调用 LLM 生成文本，请注意提示的设置。`,
      ...
      keywordDescription: `该组件用于从用户的问题中提取关键词。Top N 指定需要提取的关键词数量。`,
...
以上就是你需要总结的内容。`,
      ...
      exeSQL: '执行 SQL',
      exeSQLDescription:
        '该组件通过SQL语句从相应的关系数据库中查询结果。支持 MySQL，PostgreSQL，MariaDB。',
      dbType: '数据库类型',
      database: '数据库',
      username: '用户名',
      userId: '用户 ID',
...
重要的结构化信息可能包括：姓名、日期、地点、事件、关键事实、数字数据或其他可提取 Entities。`,
        },
        user: {
          keywords: `文本内容
[在此处插入文本]`,
...
[在此处插入文本]`,
      ...
      cancel: '取消',
      filenameEmbeddingWeight: '文件名 Embedding 权重',
    ...
    dataflowParser: {
      ...
      unlinkPipelineModalTitle: '解绑 pipeline',
    ...
    empty: {
      ...
      skillsTitle: '尚未创建 Skills 空间',
      notFoundSkills: '未查询到 Skills 空间',
      addNow: '立即添加',
    },
